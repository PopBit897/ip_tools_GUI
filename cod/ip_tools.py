...
class info1:
    ...
    Os= windows,Mac and GUI/linux """, bg='black', fg='red')
        ...
        self.bt_m.configure(bg='red',fg='black',activebackground='black',activeforeground='red')
...
class ip_web:
    def __init__( self):
        ...
        def go1():
            try :
                ...
                def save():
                        ...
                        src = input("write destination: ")
                        filepath = src

                        file =open(filepath, 'w')
                        file.write(web_ip)
                        file.close()
                        print("ok file save : ",filepath)
                ...
                bt_res.configure(bg='red',fg='black',activeforeground='red',activebackground='black')
       ...
       # label res
        ...
        bt_help.configure(bg='red',state=DISABLED,fg='black',activeforeground='red',activebackground='black')
...
class frame():
    def __init__(self,master):
        ...
        self. Frame1.place(relx=0.068, rely=0.044, relheight=0.744
                                      , relwidth=0.899)
        ...
        self.bt_next = tk.Button(root,text='web_ip',command= ip_web,bg='red',fg='black',activebackground='black',activeforeground='red',relief='flat',borderwidth='2')
        self.bt_next.place(relx=0.100, rely=0.822, height=44, width=217)
        self.bt_info = tk.Button(root,text='INFO',command=info1,bg='red',fg='black',activebackground='black',activeforeground='red',relief='flat',borderwidth='2')
